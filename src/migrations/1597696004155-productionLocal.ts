...
export class productionLocal1597696004155 implements MigrationInterface {
    name = 'productionLocal1597696004155'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "admin_bio" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "permision" character varying NOT NULL, CONSTRAINT "UQ_ad163a1cf72022448ff153431ea" UNIQUE ("email"), CONSTRAINT "PK_f8713fed3a795ee3648a61d9e0c" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "productName" character varying NOT NULL, "productDescription" character varying NOT NULL, "productTecDescription" character varying NOT NULL, "productPrice" double precision NOT NULL, "productVol" character varying NOT NULL, "photoUrl" character varying NOT NULL, "photoName" character varying NOT NULL, "brand" character varying NOT NULL, "howToStock" character varying NOT NULL, "stock" integer NOT NULL, "sellQuantity" integer, "categoryId" integer, "subCategoryId" integer, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "order_detail" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "productName" character varying NOT NULL, "productDescription" character varying NOT NULL, "photoUrl" character varying NOT NULL, "price" double precision NOT NULL, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "produtoIdId" uuid, CONSTRAINT "PK_0afbab1fa98e2fb0be8e74f6b38" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "demand" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "totalPrice" double precision NOT NULL, "shipValue" double precision NOT NULL, "vaucher" character varying NOT NULL, "shipStatus" character varying NOT NULL, "shipZipcode" character varying NOT NULL, "shipCity" character varying NOT NULL, "shipState" character varying NOT NULL, "shipStreet" character varying NOT NULL, "shipNumber" character varying NOT NULL, "shipNeighborhood" character varying NOT NULL, "shipComplement" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_2e27cd7b3d79c50d197cb0b3924" PRIMARY KEY ("id"))`, undefined);
